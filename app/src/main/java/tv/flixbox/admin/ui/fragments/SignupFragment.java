...
public class SignupFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState){
        ...
        TextInputEditText firstName = getView().findViewById(R.id.first_name);
        TextInputEditText lastName = getView().findViewById(R.id.last_name);
        TextInputEditText email = getView().findViewById(R.id.email);
        TextInputEditText password = getView().findViewById(R.id.password);
        TextInputEditText retypePassword = getView().findViewById(R.id.retype_password);
        ...
        getView().findViewById(R.id.signup).setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                call(("fname="+firstName.getText().toString()+
                        ...
                        "&rpwd="+retypePassword.getText().toString()).getBytes());
            }
        });
    }
